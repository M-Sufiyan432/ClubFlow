...
export const RSVPToggle: React.FC<RSVPToggleProps> = ({ eventId, currentStatus, onRSVPChange }) => {
  ...
  const rsvpOptions = [
    { value: RSVPStatus.GOING, label: 'Going', color: 'bg-green-100 text-green-700 hover:bg-green-200' },
    { value: RSVPStatus.INTERESTED, label: 'Interested', color: 'bg-blue-100 text-blue-700 hover:bg-blue-200' },
    { value: RSVPStatus.NOT_GOING, label: 'Not Going', color: 'bg-red-100 text-red-700 hover:bg-red-200' },
  ]
